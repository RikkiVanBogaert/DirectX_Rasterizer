...
{
	//using globally didnt work for some reason, try to fix
	Matrix translationMatrix = Matrix{Vector3::UnitX, Vector3::UnitY, Vector3::UnitZ, Vector3::Zero };
	Matrix rotationMatrix = Matrix{ Vector3::UnitX, Vector3::UnitY, Vector3::UnitZ, Vector3::Zero };
	Matrix scaleMatrix = Matrix{ Vector3::UnitX, Vector3::UnitY, Vector3::UnitZ, Vector3::Zero };
